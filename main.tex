...
\section{Experiment 1: Theoretical Framework for Wasserstein Distance/Sliced Wasserstein (SW) Distance}
...
\section{Experiment 2: Design methodology for Monte Carlo for SW - Synthetic Data Testing}
...
\section{Experiment 3: Application of Monte Carlo SW for Real Data and Analysis}
...
\section{Experiment 4: Performance analysis of regime detection using trading strategies}
\begin{itemize}
...
\subsection{Performance Analysis for Trading Strategies: Ledoit-Wolf test on sharpe ratios}
...
Need to read more about shap analysis in \cite{LedoitWolf2008}


\subsection{Tuning the weights for ensemble methods}
...
\subsection{Tuning the gradient weight for implied probability methods}
...
\subsection{Tuning the temperature parameter $\tau$ }
Compared $\tau$ taken as adaptative to the 
